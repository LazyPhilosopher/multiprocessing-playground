...
class BaseServiceModule:
    ...
    """
    def __init__(self, name, result_storage = None, result_storage_mutex: multiprocessing.Lock = None):
        self.name = name
        self.input_queue = multiprocessing.Queue()
        self.running = multiprocessing.Event()
        self.running.set()
        self.result_storage = result_storage  # Store reference to the shared result storage
        self.result_storage_mutex: threading.Lock = result_storage_mutex
    ...
    def _process_loop(self):
        ...
        while self.running.is_set():
            removal_keys = []
            with self.result_storage_mutex:
